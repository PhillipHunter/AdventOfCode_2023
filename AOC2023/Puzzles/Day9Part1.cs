using AOC2023;
using AOC2023.Models.Day9Part1;
...
namespace AOC2023.Puzzles
{
    public class Day9Part1 : IAdventPuzzle
    {
        ...
        public Day9Part1()
        {
            Name = "Day 9 Part 1: Mirage Maintenance";
            Solution = "1930746032";
        }
        ...
        public PuzzleOutput GetOutput()
        {
            ...
            {
                nextValues.Add(sensorData.GetNextValue());
            }
...
namespace AOC2023.Models.Day9Part1
{
    public class Report
    {
    ...
    public class SensorData
    {
        ...
        public long GetNextValue()
        {
            ...
            nestedData = nestedData.Prepend(Data).ToList();
